...
# Starts a scenario with a repository at Apache NiFi Registry 2.11.0 which has already
...
scenario() {
	...
	cat > defaults/main.yml <<-'YAML'
		# nifi_registry_version: 9.9.9
		# renovate: datasource=docker depName=apache/nifi-registry versioning=semver
		nifi_registry_version: 2.11.0
		nifi_registry_container_image_tag: "{{ nifi_registry_version }}"
	YAML
	printf 'placeholder\n' > files/conf/nifi-registry.properties
	printf 'placeholder\n' > meta/main.yml
	printf 'placeholder\n' > tasks/main.yml
	printf 'placeholder\n' > templates/env.j2
	printf 'placeholder\n' > README.md
...
bump_version="sed -i 's|^nifi_registry_version: 2.11.0|nifi_registry_version: 2.12.0|' defaults/main.yml"
revert_version="sed -i 's|^nifi_registry_version: 2.12.0|nifi_registry_version: 2.11.0|' defaults/main.yml"
patch_version="sed -i 's|^nifi_registry_version: 2.11.0|nifi_registry_version: 2.11.1|' defaults/main.yml"
